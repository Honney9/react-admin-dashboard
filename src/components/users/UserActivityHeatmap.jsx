        ...
        <ResponsiveContainer>
            ...
            >
               <CartesianGrid strokeDasharray='3 3' stroke='#374151' />
                ...
                />
                <Legend />
                <Bar dataKey='0-4' stackId='a' fill='#6366F1'></Bar>
                <Bar dataKey='4-8' stackId='a' fill='#885CF6'></Bar>
                <Bar dataKey='8-12' stackId='a' fill='#EC4899'></Bar>
                <Bar dataKey='12-16' stackId='a' fill='#10B981'></Bar>
                <Bar dataKey='16-20' stackId='a' fill='#F59E0B'></Bar>
                <Bar dataKey='20-24' stackId='a' fill='#3B82F6'></Bar>
            </BarChart>
        </ResponsiveContainer>
        </div>
    </motion.div>
